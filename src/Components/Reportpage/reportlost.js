...
export default function Reportlost(props) {
    const [reportlost, setreportlost] = useState([]);
    ...
    useEffect(() => {
        ...
        firestore.collection("Report").where("typePost","==","Lostandfound").get()
        .then((querySnapshot) => {
